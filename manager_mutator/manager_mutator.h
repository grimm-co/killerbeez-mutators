...
#ifdef _WIN32
#ifdef MANAGER_MUTATOR_EXPORTS
#define MANAGER_MUTATOR_API __declspec(dllexport)
#else
#define MANAGER_MUTATOR_API __declspec(dllimport)
#endif
#else //_WIN32
#define MANAGER_MUTATOR_API
#endif

#define MUTATOR_NAME "manager"
...
#define manager_free_state default_free_state
